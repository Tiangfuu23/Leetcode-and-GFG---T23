...
ll min_range(ll tree[], int node, int node_low, int node_high, int l, int r){
    ...
    return min(min_range(tree, node * 2, node_low, lil, l, r), min_range(tree, node * 2 + 1, lil + 1, node_high, l, r));
}
...
void solve() {
    ...
    while(q--){
        ...
        if(t == 1){
            ...
            // return min in range a,b
            ll res = min_range(tree, 1, 0, n-1, a-1, b-1);
            cout << res << endl;
        }
    }
}
